...
from webadmin.core.lib.mystat import MystatFormated
import sys, getopt
import sqlite3
from webadmin.core.lib.host import *
from webadmin.core.lib.DBOperate import recordmap
import re
import json
from webadmin.core.lib.email import server,mail_content
Objects = {}
RuleHead = ''
def getReportTxt():
    Report = {}
